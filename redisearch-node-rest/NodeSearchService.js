...
const redisHost = process.env.REDIS_HOST || 'redis-14683.c246.us-east-1-4.ec2.cloud.redislabs.com';
const redisPort = process.env.REDIS_PORT || 14683;
const redisPassword = process.env.REDIS_PASSWORD || '9hsNrakQA6afH6s7VV8pKIzywIGay9yF';
...
console.log(`Configuration Index: ${indexNameMovies} - redisUrl: ${redisHost}:${redisPort}`);
redisearch(redis);
